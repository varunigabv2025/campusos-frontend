      ...
      {leaderboardData.length === 0 ? (
        <FadeIn delay={0.08}>
          <div className="card-surface p-12 text-center max-w-lg mx-auto mt-8 flex flex-col items-center">
            ...
            <h3 className="text-lg font-bold text-ink mb-2">Leaderboard is Empty</h3>
            <p className="text-sm text-ink-soft mb-6 leading-relaxed">
              No points have been earned yet. Participate in events and contribute to club projects to earn your rank on the podium!
            </p>
          </div>
        </FadeIn>
      ) : (
