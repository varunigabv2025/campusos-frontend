    ...
    <div className="space-y-6">
      ...
      {activeTab === 'showcase' && (
        <div className="space-y-8">
          ...
          {featuredProjects.length === 0 && filteredShowcase.length === 0 ? (
            <FadeIn delay={0.12}>
              <div className="card-surface p-12 text-center max-w-lg mx-auto mt-8 flex flex-col items-center">
                ...
                <h3 className="text-lg font-bold text-ink mb-2">No Projects Showcased</h3>
                <p className="text-sm text-ink-soft mb-6 leading-relaxed">
                  No projects have been uploaded to the showcase yet.
                </p>
              </div>
            </FadeIn>
          ) : (
          ...
          {filteredTracker.length === 0 ? (
            <FadeIn delay={0.08}>
              <div className="card-surface p-12 text-center max-w-lg mx-auto mt-8 flex flex-col items-center">
                ...
                <h3 className="text-lg font-bold text-ink mb-2">No Active Projects</h3>
                <p className="text-sm text-ink-soft mb-6 leading-relaxed">
                  There are no active projects being tracked. Click "New Project" to create one.
                </p>
                {canCreate && (
                  <Button leftIcon="Plus" onClick={() => setIsCreateOpen(true)}>New Project</Button>
                )}
              </div>
            </FadeIn>
          ) : (
