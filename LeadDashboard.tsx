            ...
            <Card>
              ...
              <div className="space-y-3">
                {mockPendingApprovals.length === 0 ? (
                  <div className="rounded-xl border border-dashed border-border-soft p-6 text-center text-xs text-ink-soft bg-cream-50/30">
          ...
          <FadeIn delay={0.14}>
            <Card>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {projects.length === 0 ? (
                  <div className="col-span-2 rounded-xl border border-dashed border-border-soft p-6 text-center text-xs text-ink-soft bg-cream-50/30">
                    No active projects. Create a project to start tracking progress.
                  </div>
                ) : (
          ...
          <FadeIn delay={0.18}>
            <Card>
              ...
              <div className="space-y-2.5">
                {mockRecentRegistrations.length === 0 ? (
                  <div className="rounded-xl border border-dashed border-border-soft p-6 text-center text-xs text-ink-soft bg-cream-50/30">
        ...
        <div className="space-y-6">
          ...
          <FadeIn delay={0.14}>
            <Card>
              ...
              />
              <div className="space-y-2.5">
                {mockClubMembers.length === 0 ? (
                  <div className="rounded-xl border border-dashed border-border-soft p-6 text-center text-xs text-ink-soft bg-cream-50/30">
                    No active members enrolled.
                  </div>
                ) : (
            ...
            <Card>
              ...
              <div className="space-y-2.5">
                {mockTodayEvents.length === 0 ? (
                  <div className="rounded-xl border border-dashed border-border-soft p-6 text-center text-xs text-ink-soft bg-cream-50/30">
                    No club events scheduled for today.
                  </div>
                ) : (
